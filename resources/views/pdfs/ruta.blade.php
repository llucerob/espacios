...
<div class="receipt-main">
   ...
   <table class="col-8 table mt-3">
    <tr class="text-left">
        <p>&nbsp;&nbsp;&nbsp;Vehiculo {{$modelo}}, patente {{$patente}} es utilizado  por {{$nombre}}, <br> Rut {{$rut}}, Póliza Nº {{$poliza}} desde: {{$horasalida}}, con destino a <br>{{$destino}}, por el siguiente motivo: {{$objetivo}}.</p>
        <p>Hora tentativa de regreso: {{$regreso}}.</p>
    </tr>

    <tr>
        <p>km Inicial:  {{$inicial}} kms.</p>
        <p>km Final: ______________________</p>
    </tr>
